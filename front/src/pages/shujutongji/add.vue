...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="点赞量" prop="dianzanliang">
            <el-input v-model.number="ruleForm.dianzanliang" 
                placeholder="点赞量" clearable :disabled=" false  ||ro.dianzanliang"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="评论量" prop="pinglunliang">
            <el-input v-model.number="ruleForm.pinglunliang" 
                placeholder="评论量" clearable :disabled=" false  ||ro.pinglunliang"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="统计日期" prop="tongjiriqi">
              <el-date-picker
