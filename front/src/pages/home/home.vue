...
<!-- 商品推荐 -->
<div id="animate_recommendnongyezhishi" class="recommend animate__animated" :style='{"padding":"20px 0","margin":"0 auto","borderColor":"#ddd","background":"url(http://codegen.caihongy.cn/20230921/12de1b225a744f6a8b34b9e1979637b7.jpg),#fff","borderWidth":"1px 0","width":"100%","borderStyle":"solid","order":"3"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"30px auto","lineHeight":"50px","textAlign":"center","background":"none"}'>
		<span :style='{"color":"#333","fontSize":"32px","lineHeight":"40px"}'>农业知识推荐</span>
	</div>
	...
	<div class="list list1 index-pv1" :style='{"padding":"0 7%","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"cursor":"pointer","padding":"0 0 10px","boxShadow":"0px 26px 26px -30px #999","margin":"0 0 30px","background":"#f5f5f5","display":"inline-block","width":"18%","position":"relative","height":"auto"}' v-for="(item,index) in nongyezhishiRecommend" :key="index" @click="toDetail('nongyezhishiDetail', item)" class="list-item animation-box">
			...
			<div class="name line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.biaoti}}</div>
			<div class="name line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.nongyefenlei}}</div>
	...
	<div @click="moreBtn('nongyezhishi')" :style='{"border":"1px solid #ddd","cursor":"pointer","margin":"20px auto","textAlign":"center","background":"#fff","display":"block","width":"120px","lineHeight":"36px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendnongyezhishi',css:'animate__fadeInLeft'},
      ...
      getSystemIntroduction() {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "nongyezhishi/autoSort";
			data = {
				page: 1,
				limit: 15,
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.nongyezhishiRecommend = res.data.data.list;
