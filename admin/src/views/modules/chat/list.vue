        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"cursor":"pointer","padding":"0 4px","margin":"0 2px 5px 0","borderColor":"#fff","color":"#333","minWidth":"40px","borderRadius":"20px","background":"none","borderWidth":"0px","width":"auto","fontSize":"inherit","lineHeight":"24px","position":"relative","borderStyle":"solid","height":"24px"}'
                size="small"
